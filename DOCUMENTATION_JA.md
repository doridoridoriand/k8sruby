...
| --- | --- | --- |
| 1.31 | release-1.35 | 1.35.0.1 |
| 1.32 | release-1.35 | 1.35.0.1 |
| 1.33 | release-1.35 | 1.35.0.1 |
| 1.34 | release-1.35 | 1.35.0.1 |
| 1.35 | release-1.35 | 1.35.0.1 |
...
これにより、`kruby-1.35.0.1.gem`ファイルが生成されます。
...
```bash
gem install ./kruby-1.35.0.1.gem
```
...
正常にインストールされていれば、バージョン番号（例: `1.35.0.1`）が表示されます。
